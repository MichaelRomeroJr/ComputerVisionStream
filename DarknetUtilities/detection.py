...
from OperatingUtilities import utils as operatingutilities
...
num_classes = 80
classes = load_classes("C:/Python/Side Projects/Fortnite-Object-Detection-master/Yolov3-Fortnite/data/coco.names")
...
def Run(objects=None):   
    ...
    try: 
        ...
        classes = load_classes(f"{dir_path}/coco.names")
